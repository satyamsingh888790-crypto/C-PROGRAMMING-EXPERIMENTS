// WAP using a ternary operator — the user should input the length and breadth of rectangles. Find out which rectangle has the highest perimeter. The minimum number of rectangles should be three.
#include <stdio.h>
